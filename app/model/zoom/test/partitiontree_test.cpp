...
TEST_CASE("Partitiontree creates and gets correct buckets", "[partitiontree]") {
    ...
    SECTION("Partitiontree::getPoints queries return correct points.") {
        ...
        REQUIRE((q1.size() == 2 && q1[0] == Point2D(0, 0) && q1[1] == Point2D(1, 0))==true);
        REQUIRE((q2.size() == 2 && q2[0] == Point2D(2, 0) && q2[1] == Point2D(3, 0))==true);
        REQUIRE((q3.size() == 2 && q3[0] == Point2D(2, 2) && q3[1] == Point2D(3, 2))==true);
        REQUIRE((q4.size() == 1 && q4[0] == Point2D(1, 0))==true);
        REQUIRE((q5.size() == 1 && q5[0] == Point2D(2, 3))==true);
        REQUIRE((q6.size() == 1 && q6[0] == Point2D(0, 0))==true);
